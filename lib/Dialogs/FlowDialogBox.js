    ...
    FlowDialogBox.prototype.render = function () {
        ...
        if (this.dialogVisible === false) {
            ...
            var _loop_1 = function (button) {
                buttons.push(React.createElement("button", { className: "fcm-modal-dialog-button-bar-button", title: "Cancel", onMouseDown: function (e) { e.stopPropagation(); button.handler(); } }, button.label));
            };
            for (var _i = 0, _a = this.dialogButtons; _i < _a.length; _i++) {
                var button = _a[_i];
                _loop_1(button);
            }
            content = (React.createElement("div", { className: "fcm-modal-redaction", onMouseMove: function (e) { _this.onMouseMove(e); }, onMouseUp: function (e) { _this.onMouseUp(e); }, onMouseDown: function (e) { _this.handleOutsideClick(e); }, onContextMenu: function (e) { e.preventDefault(); e.stopPropagation(); if (_this.props.onContextMenu) {
                    _this.props.onContextMenu();
                } } },
                React.createElement("div", { className: "fcm-modal-content", ref: function (node) { return (_this.dialog = node); } },
                    React.createElement("div", { className: "fcm-modal-dialog" },
                        React.createElement("div", { className: "fcm-modal-dialog-header", onMouseDown: function (e) { _this.onMouseDown(e); } },
                            React.createElement("div", { style: { display: 'flex', flexDirection: "row", flexGrow: 1 } },
                                React.createElement("span", { className: "fcm-modal-dialog-header-title" }, this.props.title)),
                            React.createElement("div", { style: { display: 'flex', flexDirection: "row", marginLeft: 'auto', flexGrow: 0 } },
                                React.createElement("span", { className: "glyphicon glyphicon-remove fcm-modal-dialog-header-button", style: { cursor: 'pointer', color: '#fefefe', marginRight: '5px', fontSize: '14pt' }, title: "Close", onMouseDown: function (e) { e.stopPropagation(); _this.props.onClose('cancel'); } }))),
                        React.createElement("div", { className: "fcm-modal-dialog-body" },
                            React.createElement("div", { className: "fcm-modal-dialog-body-client" }, this.props.children)),
                        React.createElement("div", { className: "fcm-modal-dialog-button-bar" }, buttons)))));
        }
        return content;
    };
