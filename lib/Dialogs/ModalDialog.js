...
exports.FlowModalDialog = void 0;
var React = require("react");
var Common_1 = require("./Common");
require("./FlowModalDialog.css");
// Declaration of the component as React Class Component
var FlowModalDialog = /** @class */ (function (_super) {
    __extends(FlowModalDialog, _super);
    // Init of the component before it is mounted.
    function FlowModalDialog(props) {
    ...
    FlowModalDialog.prototype.setDialog = function (dialog) {
        this.dialog = dialog;
        if (this.dialog) {
    ...
    FlowModalDialog.prototype.positionDialog = function () {
        if (this.dialog) {
            this.dialog.style.left = this.left + "px";
            this.dialog.style.top = this.top + "px";
        }
    };
    FlowModalDialog.prototype.stopEventBubble = function (e) {
    ...
    FlowModalDialog.prototype.componentDidMount = function () {
        this.forceUpdate();
    };
    FlowModalDialog.prototype.showDialog = function (title, content, buttons, onClose) {
    ...
    FlowModalDialog.prototype.hideDialog = function (e) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
    ...
    FlowModalDialog.prototype.handleKeyUp = function (e) {
        var _this = this;
        var keys = {
            27: function () {
                e.preventDefault();
    ...
    FlowModalDialog.prototype.handleOutsideClick = function (e) {
        if (!this.dialog) {
    ...
    FlowModalDialog.prototype.render = function () {
        var _this = this;
        var content;
    ...
    FlowModalDialog.prototype.moveMe = function (left, top) {
        this.left = left;
        this.top = top; // - this.box.getBoundingClientRect().top;
        this.positionDialog();
    };
    FlowModalDialog.prototype.onMouseDown = function (e) {
    ...
    FlowModalDialog.prototype.onMouseMove = function (e) {
        //this.stopEventBubble(e);
    ...
    FlowModalDialog.prototype.onMouseUp = function (e) {
        //this.stopEventBubble(e);
        if (this.dragEvent.type === Common_1.eDragEventType.dialog) {
            this.dragEvent.end(null, e.clientX, e.clientY);
        }
    };
    return FlowModalDialog;
}(React.Component));
exports.FlowModalDialog = FlowModalDialog;
