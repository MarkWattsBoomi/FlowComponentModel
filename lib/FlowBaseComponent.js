            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        if (!flowModel) return [3 /*break*/, 9];
                        _a = flowModel.contentType;
                        switch (_a) {
                            case 'ContentObject': return [3 /*break*/, 1];
                            case 'ContentList': return [3 /*break*/, 5];
                        }
                        return [3 /*break*/, 7];
                    case 1:
                        objectData = void 0;
                        if (!(flowState.objectData && flowState.objectData[0] && flowState.objectData[0].properties.length > 0)) return [3 /*break*/, 3];
