    ...
    FlowBaseComponent.prototype.getStateValue = function () {
        ...
        if (flowModel) {
            switch (flowModel.contentType) {
                case 'ContentObject':
                    return flowState.objectData && flowState.objectData[0] && flowState.objectData[0].properties.length > 0 ? new FlowObjectData_1.FlowObjectData([flowState.objectData[0]]) : undefined;
                case 'ContentList':
