...
var FlowBaseComponent = /** @class */ (function (_super) {
    ...
    FlowBaseComponent.prototype.preserveState = function () {
        return __awaiter(this, void 0, void 0, function () {
            var flowModel, flowState, _a, objectData, od, listData;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        this.LoadingState = eLoadingState.mounting;
                        ...
                        switch (_a) {
                            ...
                            case 'ContentList': return [3 /*break*/, 3];
                        }
                        return [3 /*break*/, 5];
                    case 1:
                        objectData = void 0;
                        ...
                        od = new FlowObjectData_1.FlowObjectData([objectData]);
                        return [4 /*yield*/, this.setStateValue(od, true)];
                    case 2:
                        _b.sent();
                        return [3 /*break*/, 7];
                    case 3:
                    ...
                    case 4:
                        _b.sent();
                        return [3 /*break*/, 7];
                    case 5: return [4 /*yield*/, this.setStateValue(flowModel.contentValue, true)];
                    case 6:
                        _b.sent();
                        return [3 /*break*/, 7];
                    case 7:
    ...
    FlowBaseComponent.prototype.getStateValue = function () {
        ...
        switch (flowModel.contentType) {
            case 'ContentObject':
                return flowState.objectData && flowState.objectData[0] && flowState.objectData[0].properties.length > 0 ? new FlowObjectData_1.FlowObjectData([flowState.objectData[0]]) : new FlowObjectData_1.FlowObjectData(flowModel.objectData);
            case 'ContentList':
                return new FlowObjectDataArray_1.FlowObjectDataArray(flowState.objectData ? flowState.objectData : []);
                break;
            default:
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        this.LoadingState = eLoadingState.moving;
                        baseUrl = manywho.settings.global('platform.uri') || window.location.origin || 'https://flow.manywho.com';
