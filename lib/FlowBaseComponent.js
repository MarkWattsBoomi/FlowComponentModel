...
var FlowBaseComponent = /** @class */ (function (_super) {
    ...
    FlowBaseComponent.prototype.getStateValue = function () {
        ...
        switch (flowModel.contentType) {
            case 'ContentObject':
                return flowState.objectData && flowState.objectData[0] ? new FlowObjectData_1.FlowObjectData([flowState.objectData[0]]) : new FlowObjectData_1.FlowObjectData(flowModel.objectData);
            case 'ContentList':
